...
def poblar_db():
    ...
    usuaria_alumna51 = User.objects.create_user(username="alumna51", first_name="Fernanda", last_name="Macías", password="contraseña123", es_alumna=True)

    usuaria_alumna52 = User.objects.create_user(username="alumna52", first_name="Ignacia", last_name="Macías", password="contraseña123", es_alumna=True)

    usuaria_alumna53 = User.objects.create_user(username="alumna53", first_name="Ignacia", last_name="Labarca", password="contraseña123", es_alumna=True)

    usuaria_alumna54 = User.objects.create_user(username="alumna54", first_name="Karina", last_name="Rozas", password="contraseña123", es_alumna=True)

    usuaria_alumna55 = User.objects.create_user(username="alumna55", first_name="Florencia", last_name="Manríquez", password="contraseña123", es_alumna=True)

    usuaria_alumna56 = User.objects.create_user(username="alumna56", first_name="Antonia", last_name="Jimenez", password="contraseña123", es_alumna=True)

    usuaria_alumna57 = User.objects.create_user(username="alumna57", first_name="Constanza", last_name="Mora", password="contraseña123", es_alumna=True)

    usuaria_alumna58 = User.objects.create_user(username="alumna58", first_name="Rosario", last_name="González", password="contraseña123", es_alumna=True)

    usuaria_alumna59 = User.objects.create_user(username="alumna59", first_name="Lupe", last_name="Rojas", password="contraseña123", es_alumna=True)

    usuaria_alumna60 = User.objects.create_user(username="alumna60", first_name="Martina", last_name="Monsalves", password="contraseña123", es_alumna=True)

    usuaria_alumna61 = User.objects.create_user(username="alumna61", first_name="Belén", last_name="Acevedo", password="contraseña123", es_alumna=True)

    usuaria_alumna62 = User.objects.create_user(username="alumna62", first_name="Francisca", last_name="Riquelme", password="contraseña123", es_alumna=True)

    usuaria_alumna63 = User.objects.create_user(username="alumna63", first_name="Gabriela", last_name="Herrera", password="contraseña123", es_alumna=True)

    usuaria_alumna64 = User.objects.create_user(username="alumna64", first_name="Francisca", last_name="Fabres", password="contraseña123", es_alumna=True)

    usuaria_alumna65 = User.objects.create_user(username="alumna65", first_name="Bárbara", last_name="Fuentes", password="contraseña123", es_alumna=True)

    usuaria_alumna66 = User.objects.create_user(username="alumna66", first_name="Paula", last_name="Cifuentes", password="contraseña123", es_alumna=True)

    usuaria_alumna67 = User.objects.create_user(username="alumna67", first_name="Paulina", last_name="Lagos", password="contraseña123", es_alumna=True)

    usuaria_alumna68 = User.objects.create_user(username="alumna68", first_name="Alejandra", last_name="Rivas", password="contraseña123", es_alumna=True)

    usuaria_alumna69 = User.objects.create_user(username="alumna69", first_name="Mabel", last_name="Recabarren", password="contraseña123", es_alumna=True)

    usuaria_alumna70 = User.objects.create_user(username="alumna70", first_name="Teresa", last_name="Paredes", password="contraseña123", es_alumna=True)

    usuaria_alumna71 = User.objects.create_user(username="alumna71", first_name="Alicia", last_name="Cuadra", password="contraseña123", es_alumna=True)

    usuaria_alumna72 = User.objects.create_user(username="alumna72", first_name="Cecilia", last_name="Poblete", password="contraseña123", es_alumna=True)

    usuaria_alumna73 = User.objects.create_user(username="alumna73", first_name="Marta", last_name="Osorio", password="contraseña123", es_alumna=True)

    usuaria_alumna74 = User.objects.create_user(username="alumna74", first_name="Natalia", last_name="Arce", password="contraseña123", es_alumna=True)

    usuaria_alumna75 = User.objects.create_user(username="alumna75", first_name="Daniela", last_name="Medina", password="contraseña123", es_alumna=True)

    usuaria_alumna76 = User.objects.create_user(username="alumna76", first_name="Gabriela", last_name="Cuadra", password="contraseña123", es_alumna=True)

    usuaria_alumna77 = User.objects.create_user(username="alumna77", first_name="Luciana", last_name="Díaz", password="contraseña123", es_alumna=True)

    usuaria_alumna78 = User.objects.create_user(username="alumna78", first_name="Lucia", last_name="Cáceres", password="contraseña123", es_alumna=True)

    usuaria_alumna79 = User.objects.create_user(username="alumna79", first_name="Laura", last_name="Mierzo", password="contraseña123", es_alumna=True)

    usuaria_alumna80 = User.objects.create_user(username="alumna80", first_name="Scarlett", last_name="Suarez", password="contraseña123", es_alumna=True)

    usuaria_alumna81 = User.objects.create_user(username="alumna81", first_name="Catalina", last_name="Bravo", password="contraseña123", es_alumna=True)

    usuaria_alumna82 = User.objects.create_user(username="alumna82", first_name="Alejandra", last_name="Muñoz", password="contraseña123", es_alumna=True)

    usuaria_alumna83 = User.objects.create_user(username="alumna83", first_name="Josefa", last_name="Perez", password="contraseña123", es_alumna=True)

    usuaria_alumna84 = User.objects.create_user(username="alumna84", first_name="Josefina", last_name="Quiróz", password="contraseña123", es_alumna=True)

    usuaria_alumna85 = User.objects.create_user(username="alumna85", first_name="Monserrat", last_name="Martinez", password="contraseña123", es_alumna=True)

    usuaria_alumna86 = User.objects.create_user(username="alumna86", first_name="Valentina", last_name="Ruiz", password="contraseña123", es_alumna=True)

    usuaria_alumna87 = User.objects.create_user(username="alumna87", first_name="Margarita", last_name="Elfernan", password="contraseña123", es_alumna=True)

    usuaria_alumna88 = User.objects.create_user(username="alumna88", first_name="Javiera", last_name="Ramos", password="contraseña123", es_alumna=True)

    usuaria_alumna89 = User.objects.create_user(username="alumna89", first_name="María José", last_name="Del Campo", password="contraseña123", es_alumna=True)

    usuaria_alumna90 = User.objects.create_user(username="alumna90", first_name="Kiara", last_name="De la Maza", password="contraseña123", es_alumna=True)

    usuaria_alumna91 = User.objects.create_user(username="alumna91", first_name="Karen", last_name="James", password="contraseña123", es_alumna=True)

    usuaria_alumna92 = User.objects.create_user(username="alumna92", first_name="Sofía", last_name="Toledo", password="contraseña123", es_alumna=True)

    usuaria_alumna93 = User.objects.create_user(username="alumna93", first_name="Agustina", last_name="Timana", password="contraseña123", es_alumna=True)

    usuaria_alumna94 = User.objects.create_user(username="alumna94", first_name="Dominga", last_name="Espinoza", password="contraseña123", es_alumna=True)

    usuaria_alumna95 = User.objects.create_user(username="alumna95", first_name="Asunción", last_name="Gómez", password="contraseña123", es_alumna=True)

    usuaria_alumna96 = User.objects.create_user(username="alumna96", first_name="Karen", last_name="James", password="contraseña123", es_alumna=True)

    usuaria_alumna97 = User.objects.create_user(username="alumna97", first_name="Sofía", last_name="Toledo", password="contraseña123", es_alumna=True)

    usuaria_alumna98 = User.objects.create_user(username="alumna98", first_name="Agustina", last_name="Timana", password="contraseña123", es_alumna=True)

    usuaria_alumna99 = User.objects.create_user(username="alumna99", first_name="Dominga", last_name="Espinoza", password="contraseña123", es_alumna=True)
    ...
    clase_basico2 = Clase.objects.create(nombre="Ciclos while", curso=curso_basico,fecha_clase=datetime.date(2020,4,11))
    ...
    clase_medio3 = Clase.objects.create(nombre="Listas Enlazadas", curso=curso_medio,fecha_clase=datetime.date(2020,4,18))
    clase_medio4 = Clase.objects.create(nombre="Intro a la Programación Competitiva", curso=curso_medio,fecha_clase=datetime.date(2020,4,25))
    clase_medio5 = Clase.objects.create(nombre="Intro a la Programación Competitiva 2", curso=curso_medio,fecha_clase=datetime.date(2020,5,2))


    clase_basico_umayor1 = Clase.objects.create(nombre="Clase 1: Ciclos for", curso=curso_basico_umayor,fecha_clase=datetime.date(2020,4,4))
    clase_basico_umayor2 = Clase.objects.create(nombre="Clase 2: Ciclos while", curso=curso_basico_umayor,fecha_clase=datetime.date(2020,4,11))
    clase_basico_umayor3 = Clase.objects.create(nombre="Clase 3: Grafos", curso=curso_basico_umayor,fecha_clase=datetime.date(2020,4,18))
    clase_basico_umayor4 = Clase.objects.create(nombre="Clase 4: DBS", curso=curso_basico_umayor,fecha_clase=datetime.date(2020,4,25))
    clase_basico_umayor5 = Clase.objects.create(nombre="Clase 5: DFS", curso=curso_basico_umayor,fecha_clase=datetime.date(2020,5,2))


    clase_medio_umayor1 = Clase.objects.create(nombre="Clase 1: Arreglos", curso=curso_medio_umayor,fecha_clase=datetime.date(2020,4,4))
    clase_medio_umayor2 = Clase.objects.create(nombre="Clase 2: Variables", curso=curso_medio_umayor,fecha_clase=datetime.date(2020,4,11))
    clase_medio_umayor3 = Clase.objects.create(nombre="Clase 3: Listas Enlazadas", curso=curso_medio_umayor,fecha_clase=datetime.date(2020,4,18))
    clase_medio_umayor4 = Clase.objects.create(nombre="Clase 4: Intro a la Programación Competitiva", curso=curso_medio_umayor,fecha_clase=datetime.date(2020,4,25))
    clase_medio_umayor5 = Clase.objects.create(nombre="Clase 5: Intro a la Programación Competitiva 2", curso=curso_medio_umayor,fecha_clase=datetime.date(2020,5,2))
